...
@interface CPSBannerSource : NSObject <BSInvalidatable, CPBannerProviding, CPSApplicationStateObserving, CPSBannerItemDelegate, CPSBannerViewControllerDelegate> {
