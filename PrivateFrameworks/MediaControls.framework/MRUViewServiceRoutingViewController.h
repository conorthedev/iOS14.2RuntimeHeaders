...
@interface MRUViewServiceRoutingViewController : UIViewController <MRUEndpointMetadataControllerObserver, MRURoutingViewControllerDelegate, MediaControlsEndpointsManagerDelegate, UITableViewDelegate> {
