...
@interface HRElectrocardiogramOnboardingManager : NSObject <HROnboardingElectrocardiogramSetupCompleteViewControllerDelegate, HROnboardingManagerDataSource, HROnboardingManagerDelegate> {
