...
@interface PKAccessoryDeviceExpressAlertViewController : SBUIRemoteAlertServiceViewController <PKAccessoryDeviceMonitorDelegate, SBSHardwareButtonEventConsuming> {
