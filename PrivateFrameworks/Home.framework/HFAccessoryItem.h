...
@interface HFAccessoryItem : HFItem <HFActionBuilderFactory, HFCompoundItemProtocol, HFGroupableItemProtocol, HFServiceLikeBuilderCreating, HFServiceLikeItem, HUServiceContainerItem> {
