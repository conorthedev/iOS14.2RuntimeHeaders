...
@property (nonatomic, retain) MRMigrationDevice *migratingDevice;
...
+ (void)_migrate:(id)arg1 destinationEndpoint:(id)arg2 outputDevice:(id)arg3 label:(id)arg4 completion:(id /* block */)arg5;
