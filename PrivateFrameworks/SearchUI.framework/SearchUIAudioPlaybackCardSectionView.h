...
@interface SearchUIAudioPlaybackCardSectionView : SearchUICardSectionView <NUIContainerViewDelegate, SearchUICardSectionViewUpdatable, SearchUISelectableTextViewDelegate> {
