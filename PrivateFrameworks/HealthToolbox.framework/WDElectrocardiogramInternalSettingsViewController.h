...
@interface WDElectrocardiogramInternalSettingsViewController : HKTableViewController <HRElectrocardiogramOnboardingManagerDelegate, UIPickerViewDataSource, UIPickerViewDelegate> {
