...
- (void)enumerateEnclosingRectsForGlyphRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 insetForBackground:(bool)arg2 usingBlock:(id /* block */)arg3;
