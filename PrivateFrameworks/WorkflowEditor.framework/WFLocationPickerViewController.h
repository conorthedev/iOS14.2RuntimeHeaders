...
@interface WFLocationPickerViewController : UIViewController <CLLocationManagerDelegate, HULocationTriggerEditorMapDragRadiusViewDelegate, MKMapViewDelegate, MKMapViewDelegatePrivate, UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate> {
