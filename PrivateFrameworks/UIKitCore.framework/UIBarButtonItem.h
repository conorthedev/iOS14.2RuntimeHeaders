...
+ (id)flex_backItemWithTitle:(id)arg1;
+ (id)flex_disabledItemWithImage:(id)arg1;
+ (id)flex_disabledItemWithTitle:(id)arg1 style:(long long)arg2;
+ (id)flex_disabledSystemItem:(long long)arg1;
+ (id)flex_doneStyleitemWithTitle:(id)arg1 target:(id)arg2 action:(SEL)arg3;
+ (id)flex_fixedSpace;
+ (id)flex_flexibleSpace;
+ (id)flex_itemWithCustomView:(id)arg1;
+ (id)flex_itemWithImage:(id)arg1 target:(id)arg2 action:(SEL)arg3;
+ (id)flex_itemWithTitle:(id)arg1 target:(id)arg2 action:(SEL)arg3;
+ (id)flex_systemItem:(long long)arg1 target:(id)arg2 action:(SEL)arg3;

- (id)flex_withTintColor:(id)arg1;
