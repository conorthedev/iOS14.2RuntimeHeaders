...
@interface WFSettingsIntentHandler : NSObject <WFSetAirplaneModeIntentHandling, WFSetAppearanceIntentHandling, WFSetBluetoothIntentHandling, WFSetBrightnessIntentHandling, WFSetCellularDataIntentHandling, WFSetFlashlightIntentHandling, WFSetLowPowerModeIntentHandling, WFSetWiFiIntentHandling>
