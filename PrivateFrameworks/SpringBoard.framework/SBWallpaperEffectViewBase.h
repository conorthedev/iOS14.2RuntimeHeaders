...
@interface SBWallpaperEffectViewBase : UIView <SBWallpaperObserver, _SBFakeBlurObserver> {
    ...
    <SBWallpaperPresenting><SBWallpaperLegibilityProviding> * _wallpaperPresenter;
}
...
@property (nonatomic, readonly) <SBWallpaperPresenting><SBWallpaperLegibilityProviding> *wallpaperPresenter;
