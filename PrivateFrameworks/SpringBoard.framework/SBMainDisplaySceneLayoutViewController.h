...
@interface SBMainDisplaySceneLayoutViewController : SBSceneLayoutViewController <PTSettingsKeyObserver, SBDeviceApplicationSceneStatusBarBreadcrumbProviderObserver, SBMainDisplaySceneLayoutStatusBarViewDataSource, SBSceneHandleObserver, SBSystemPointerInteractionDelegate, TFBetaLaunchHandleActivationDelegate> {
...
- (void)_fadeStatusBarStylesBetweenFromAndToViewControllersWithSettings:(id)arg1 completion:(id /* block */)arg2;
...
- (bool)shouldBeginPointerInteractionAtLocation:(struct CGPoint { double x1; double x2; })arg1 forView:(id)arg2;
