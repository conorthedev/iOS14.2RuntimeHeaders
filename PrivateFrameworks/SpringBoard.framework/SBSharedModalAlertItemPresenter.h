...
@interface SBSharedModalAlertItemPresenter : NSObject <SBBarSwipeAffordanceDelegate, SBBarSwipeAffordanceObserver, SBHomeGestureParticipantDelegate, SBHomeGrabberPointerClickDelegate, SBModalViewControllerStackDelegate, SBReachabilityObserver, UIAlertControllerCoordinatedActionPerforming, _SBAlertControllerDelegate> {
