...
@interface SBIdleTimerGlobalStateMonitor : NSObject <SBFThermalConditionObserver, SBIdleTimerServiceDelegate, SBPocketStateMonitorObserver, _SBIdleTimerGlobalSettingMonitorDelegate> {
