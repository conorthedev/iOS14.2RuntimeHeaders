...
@interface SBCoverSheetSecureAppEnvironmentViewController : UIViewController <CSApplicationHosting, SBCoverSheetSlidingViewControllerContentViewController, SBHomeGestureParticipantDelegate, SBHomeGrabberPointerClickDelegate, SBSecureAppObserver> {
