...
@property (getter=_batteryDomain, setter=_setBatteryDomain:, nonatomic, retain) STBatteryStatusDomain *batteryDomain;
@property (getter=_callingDomain, setter=_setCallingDomain:, nonatomic, retain) STCallingStatusDomain *callingDomain;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (nonatomic, readonly) STTelephonyStatusDomainDataProvider *telephonyDataProvider;
@property (getter=_telephonyDomain, setter=_setTelephonyDomain:, nonatomic, retain) STTelephonyStatusDomain *telephonyDomain;
...
@property (getter=_voiceControlDomain, setter=_setVoiceControlDomain:, nonatomic, retain) STVoiceControlStatusDomain *voiceControlDomain;
@property (nonatomic, readonly) SBSystemStatusWifiDataProvider *wifiDataProvider;
@property (getter=_wifiDomain, setter=_setWifiDomain:, nonatomic, retain) STWifiStatusDomain *wifiDomain;
