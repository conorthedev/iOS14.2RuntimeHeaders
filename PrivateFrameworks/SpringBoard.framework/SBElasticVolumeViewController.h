...
@property (nonatomic, readonly) struct CGPoint { double x1; double x2; } centerForVolumeHUDWhenInInteractingState;
...
- (struct CGPoint { double x1; double x2; })centerForVolumeHUDWhenInInteractingState;
