...
@interface SBDeviceApplicationSceneView : SBApplicationSceneView <PTSettingsKeyObserver, SBAppSwitcherPageContentView, SBDeviceApplicationSceneClassicAccessoryViewDelegate> {
    bool  _active;
