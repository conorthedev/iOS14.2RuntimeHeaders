...
- (void)_updateExternalForegroundApplicationScenesToInterfaceOrientation:(long long)arg1 force:(bool)arg2 prefersTouchCancellationDisabled:(bool)arg3 validator:(id /* block */)arg4;
