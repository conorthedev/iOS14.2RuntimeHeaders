...
@interface SBHomeGrabberView : UIView <MTLumaDodgePillBackgroundLuminanceObserver, PTSettingsKeyPathObserver, SBAttentionAwarenessClientDelegate, SBSystemPointerInteractionDelegate> {
    bool  _autoHides;
