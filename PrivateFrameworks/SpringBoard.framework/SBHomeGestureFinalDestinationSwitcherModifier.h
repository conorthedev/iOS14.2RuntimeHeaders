...
- (id)initWithDelegate:(id)arg1 initialTranslationAdjustment:(struct CGPoint { double x1; double x2; })arg2 startingEnvironmentMode:(long long)arg3 continuingGesture:(bool)arg4 dockModifier:(id)arg5;
- (id)studyLogData;
