...
@interface SBMainDisplaySceneLayoutDragAndDropInteractionManager : NSObject <BSTransactionObserver, SBApplicationDropSessionSceneProviding, SBDragAndDropAppActivationWorkspaceTransactionDelegate, UIDragInteractionDelegate_ForWebKitOnly, UIDragInteractionDelegate_Private, UIDropInteractionDelegate_Private> {
