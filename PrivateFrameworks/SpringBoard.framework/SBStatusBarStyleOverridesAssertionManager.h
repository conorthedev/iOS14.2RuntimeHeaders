...
@interface SBStatusBarStyleOverridesAssertionManager : NSObject <BSDescriptionProviding, NSXPCListenerDelegate, SBAppStatusBarAssertionManagerObserver, SBStatusBarStyleOverridesAssertionServer> {
...
@property (nonatomic, retain) SBAppStatusBarAssertionManager *appStatusBarAssertionManager;
