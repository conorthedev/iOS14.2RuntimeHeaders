...
@interface SBDragAndDropAppActivationWorkspaceTransaction : SBMainWorkspaceTransaction <SBSceneLayoutWorkspaceTransactionObserver, SBWorkspaceApplicationSceneTransitionContextDelegate, UIDragInteractionDelegate_Private, UIDropInteractionDelegate_Private> {
