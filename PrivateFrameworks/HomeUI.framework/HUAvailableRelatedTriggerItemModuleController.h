...
@interface HUAvailableRelatedTriggerItemModuleController : HUItemTableModuleController <HFItemSectionAccessoryButtonHeaderDelegate, HUIconSwitchCellDelegate, HUTriggerEditorDelegate> {
