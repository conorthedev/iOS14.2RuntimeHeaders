...
@property (nonatomic, retain) HUSoftwareUpdateActionAndProgressItem *softwareUpdateActionAndProgressItem;
...
- (void)setSoftwareUpdateActionAndProgressItem:(id)arg1;
...
- (id)softwareUpdateActionAndProgressItem;
