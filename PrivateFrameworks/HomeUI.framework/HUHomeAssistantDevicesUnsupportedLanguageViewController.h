...
@interface HUHomeAssistantDevicesUnsupportedLanguageViewController : OBTableWelcomeController <HUConfigurationViewController, HUPreloadableViewController, UITableViewDataSource, UITableViewDelegate> {
