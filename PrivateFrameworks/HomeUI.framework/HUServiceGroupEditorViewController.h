...
@interface HUServiceGroupEditorViewController : HUItemTableViewController <HUNameAndIconEditorCellDelegate, HUPresentationDelegateHost, HUServiceGroupEditorGridViewControllerDelegate> {
    ...
    <HUServiceGroupEditorViewControllerDelegate> * _serviceGroupEditorDelegate;
}
