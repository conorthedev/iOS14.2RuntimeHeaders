...
@interface HUNaturalLightingSetupViewController : HUItemTableOBWelcomeController <HUConfigurationViewController, HUNaturalLightingSetupModuleDelegate, HUPreloadableViewController> {
    HMHome * _home;
