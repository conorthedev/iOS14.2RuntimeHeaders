...
@interface HUAlarmTableViewController : HUItemTableViewController <HFAccessoryObserver, HFAccessorySettingMobileTimerAdapterObserver, HFMediaObjectObserver, HUAlarmEditViewControllerDelegate, HUHomePodAlarmItemModuleControllerDelegate, HUPresentationDelegateHost, UITableViewDelegatePrivate> {
