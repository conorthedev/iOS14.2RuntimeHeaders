...
@interface HUVoiceProfileSetupViewController : HUImageOBWelcomeController <HUConfigurationViewController, HUOnboardingWarningPresenter, HUPreloadableViewController, VTUIEnrollTrainingViewControllerDelegate> {
