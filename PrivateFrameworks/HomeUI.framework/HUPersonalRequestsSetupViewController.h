...
@interface HUPersonalRequestsSetupViewController : OBWelcomeController <HFItemManagerDelegate, HUConfigurationViewController, HUItemTableModuleControllerHosting, HUPreloadableViewController> {
