...
@interface HUAccessorySettingsItemModuleController : HUItemTableModuleController <HUSliderValueTableViewCellDelegate, HUStepperCellDelegate, HUSwitchCellDelegate> {
