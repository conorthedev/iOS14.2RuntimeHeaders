...
@interface HUHomePersonalIdentityDeviceConfigurationViewController : OBTableWelcomeController <HUConfigurationViewController, HUPreloadableViewController, UITableViewDataSource, UITableViewDelegate> {
