...
@interface HUTVViewingProfilesSetupViewController : HUImageOBWelcomeController <HFItemManagerDelegate, HUConfigurationViewController, HUItemTableModuleControllerHosting, HUPreloadableViewController> {
