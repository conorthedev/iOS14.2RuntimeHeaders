...
@property (nonatomic, retain) HUChimeOnHomePodListItem *chimeOnHomePodListItem;
@property (nonatomic, retain) HUChimeOnHomePodSingleItem *chimeOnHomePodSingleItem;
...
- (void)setChimeOnHomePodListItem:(id)arg1;
- (void)setChimeOnHomePodSingleItem:(id)arg1;
