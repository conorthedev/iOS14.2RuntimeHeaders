...
@interface HUContainedServicesGridViewController : HUServiceGridViewController <HUDetailsPresentationDelegateHost, HUPresentationDelegate, HUServiceGridItemManagerDelegate> {
    ...
    <HUContainedServiceGridViewControllerDelegate> * _serviceGridDelegate;
}
...
@property (nonatomic) <HUContainedServiceGridViewControllerDelegate> *serviceGridDelegate;
