...
@interface HUContainedMediaAccessoriesGridViewController : HUServiceGridViewController <HUDetailsPresentationDelegateHost, HUPresentationDelegate, HUServiceGridItemManagerDelegate> {
    <HUContainedMediaAccessoriesGridViewControllerDelegate> * _mediaAccessoryGridDelegate;
...
@property (nonatomic) <HUContainedMediaAccessoriesGridViewControllerDelegate> *mediaAccessoryGridDelegate;
