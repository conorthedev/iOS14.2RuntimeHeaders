...
@property (nonatomic, retain) SBHLocalizedIndexedCollation *collation;
...
+ (void)_hydrateSnapshot:(id)arg1 fromIcons:(id)arg2 query:(id)arg3 outCollation:(id*)arg4 outIconForItemIdentifier:(id*)arg5 outSortMethodology:(unsigned long long*)arg6 sortComparator:(id /* block */)arg7;
+ (id)nullQueryResults;
