...
- (long long)dragPlacementForDropSession:(id)arg1 iconListView:(id)arg2 point:(struct CGPoint { double x1; double x2; })arg3 icon:(id)arg4 options:(unsigned long long)arg5;
