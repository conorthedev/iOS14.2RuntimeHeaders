...
@property (nonatomic, readonly) SBHIconAccessoryCountedMapImageTuple *backgroundImageTuple;
@property (nonatomic, readonly) SBDarkeningImageView *backgroundView;
@property (nonatomic) long long badgeType;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (nonatomic, retain) SBHIconAccessoryCountedMapImageTuple *foregroundImageTuple;
...
- (void)setForegroundImageTuple:(id)arg1;
