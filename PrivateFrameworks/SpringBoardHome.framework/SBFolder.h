...
@interface SBFolder : NSObject <BSDescriptionProviding, SBFolderObserver, SBIconIndexMutableListObserver, SBIconIndexNode, SBIconListModelIconValidator, SBIconListModelObserver, SBTreeNode> {
