...
@property (nonatomic, retain) NSMapTable *resourceLoadingRequestVideoTaskMap;
...
- (id)resourceLoadingRequestVideoTaskMap;
...
- (void)setResourceLoadingRequestVideoTaskMap:(id)arg1;
