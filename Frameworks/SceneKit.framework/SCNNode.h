...
+ (id)header:(id)arg1;
+ (id)highlight:(id)arg1 color:(id)arg2;
+ (id)lineFrom:(struct SCNVector3 { float x1; float x2; float x3; })arg1 to:(struct SCNVector3 { float x1; float x2; float x3; })arg2 color:(id)arg3;
+ (id)shapeNodeWithSize:(struct CGSize { double x1; double x2; })arg1 materialDiffuse:(id)arg2 offsetZ:(bool)arg3;
+ (id)snapshot:(id)arg1;
+ (id)snapshot:(id)arg1 parent:(id)arg2 parentNode:(id)arg3 root:(id)arg4 depth:(long long*)arg5 nodesMap:(id)arg6 hideHeaders:(bool)arg7;

- (id)borderWithColor:(id)arg1;
