...
+ (id)nameHeader:(id)arg1 frame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 corners:(double)arg3;
+ (id)shapeWithPath:(id)arg1 materialDiffuse:(id)arg2;
