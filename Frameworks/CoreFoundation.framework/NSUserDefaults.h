...
@property (nonatomic, retain) NSArray *flex_networkHostBlacklist;
...
- (id)flex_defaultsPathForFile:(id)arg1;
...
- (id)flex_networkHostBlacklist;
- (bool)flex_registerDictionaryJSONViewerOnLaunch;
- (void)flex_toggleBoolForKey:(id)arg1;
- (double)flex_toolbarTopMargin;
- (void)setFlex_cacheOSLogMessages:(bool)arg1;
- (void)setFlex_disableOSLog:(bool)arg1;
- (void)setFlex_explorerHidesPropertyIvars:(bool)arg1;
- (void)setFlex_explorerHidesPropertyMethods:(bool)arg1;
- (void)setFlex_explorerHidesVariablePreviews:(bool)arg1;
- (void)setFlex_explorerShowsMethodOverrides:(bool)arg1;
- (void)setFlex_networkHostBlacklist:(id)arg1;
- (void)setFlex_registerDictionaryJSONViewerOnLaunch:(bool)arg1;
- (void)setFlex_toolbarTopMargin:(double)arg1;
