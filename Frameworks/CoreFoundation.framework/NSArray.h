...
+ (id)flex_forEachUpTo:(unsigned long long)arg1 map:(id /* block */)arg2;
+ (id)flex_mapped:(id)arg1 block:(id /* block */)arg2;

- (id)flex_filtered:(id /* block */)arg1;
- (id)flex_flatmapped:(id /* block */)arg1;
- (void)flex_forEach:(id /* block */)arg1;
- (id)flex_mapped:(id /* block */)arg1;
- (id)flex_subArrayUpto:(unsigned long long)arg1;
- (id)sortedUsingSelector:(SEL)arg1;
