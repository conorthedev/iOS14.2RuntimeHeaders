...
@property (nonatomic, readonly) BOOL flex_firstNonConstType;
@property (nonatomic, readonly) BOOL flex_pointeeType;
...
- (BOOL)flex_firstNonConstType;
- (BOOL)flex_pointeeType;
...
- (id)stringByRemovingLastKeyPathComponent;
- (id)stringByReplacingLastKeyPathComponent:(id)arg1;
- (id)stringbyDeletingCharacterAtIndex:(unsigned long long)arg1;
